    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="http://donkeycar.com/index.php" >DonkeyCar</a>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <?php if(!empty($_SESSION['user']['role']) && $_SESSION['user']['role'] == 'admin'):?>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMarket">
                                    ...
                                    <li><a class="dropdown-item" href="http://donkeycar.com/pages/admin/pageAddCar.php?id=<?= $_SESSION['user']['id']?>&role=<?= $_SESSION['user']['role']?>">Add Market</a></li>
                                    <li><a class="dropdown-item" href="http://donkeycar.com/pages/admin/pageAddCar.php?id=<?= $_SESSION['user']['id']?>&role=<?= $_SESSION['user']['role']?>">Add Garage</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                        ...
                        <?php if(!empty($_SESSION['user']['role']) && ($_SESSION['user']['role'] == 'admin' ||$_SESSION['user']['role'] == 'customer')):?>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMarket">
                                    <li><a class="dropdown-item" href="http://donkeycar.com/pages/pageListMessage.php">Message</a></li>
                                    <?php if($_SESSION['user']['role'] == 'customer') :?>
                                        <li><a class="dropdown-item" href="http://donkeycar.com/pages/pageListRental.php?role=customer"> My Rental</a></li>
                                    <?php endif;?>
